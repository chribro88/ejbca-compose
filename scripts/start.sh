...
# Configure standalone.xml for high availability
if [ "x$HIGH_AVAILABILITY" != "x" ] ; then
    appserver_config_enable_high_availability
fi
...
importExternalCaCertificatesFromDirectory ${baseDir}/secrets/external/ca/ts
